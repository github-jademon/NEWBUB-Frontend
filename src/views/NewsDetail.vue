  ...
  <div class="news-page page">
    <div class="title">
      ...
      <span
        ...
        v-for="(item, idx) in news.category"
        :key="idx"
        @click="goToNewsListPage(item)"
        style="cursor: pointer"
      >
        <span>{{ item }}</span>
        <span v-if="idx + 1 < item.length" class="newslist-line"
    ...
    <div class="news-detail">
      ...
      <div class="main-content-wrapper">
        <div class="main-content-wrapper2">
          ...
          <div class="news-main-block">
            ...
            <div class="news-meta">
              <span>
                <span
                  class="news-item"
                  v-for="(item, idx) in news.reporter"
                  :key="idx"
                  style="cursor: pointer"
                >
          ...
          <div v-for="(category, index) in news.category" :key="index">
            <div class="related-news-section">
              <h3>
                <strong>{{ newsList[index].key }}</strong>
                <span> 관련 뉴스 더보기</span>
              </h3>
              <div class="related-news-list">
                <div
                  class="related-news-item"
                  v-for="(item, idx) in newsList[index].data"
                  :key="idx"
        ...
        <div class="side-blocks">
          ...
          <div class="related-laws">
            ...
            <div class="more-law-button" @click="loadMoreLaws">법안 더보기</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    const goToNewsListPage = (category) => {
