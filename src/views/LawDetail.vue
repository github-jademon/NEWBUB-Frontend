        ...
        <div class="law-info-block">
          <div class="law-info-table">
            ...
            <div class="table-item">
              ...
              <div class="col-data">{{ law.representative }}</div>
            </div>
            <div class="table-item">
            ...
            <div class="table-item">
              ...
              <div class="col-data">{{ law.result }}</div>
            </div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const goToPartyContributionPage = (partyName) => {
      window.location.href = `/party-contribution/${partyName}`;
    };
    return {
      lawId,
      law,
